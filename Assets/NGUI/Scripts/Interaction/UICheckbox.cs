...
public class UICheckbox : MonoBehaviour
{
	...
	public delegate void OnStateChangeArg2(UICheckbox checkBox, bool state);
	...
	public OnStateChangeArg2 onStageChangeArg2;
	...
	void Set (bool state)
	{
		...
		else if (mChecked != state)
		{
			...
			if (onStageChangeArg2 != null) onStageChangeArg2(this, mChecked);
